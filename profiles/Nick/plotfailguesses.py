...
#f = open("fail_guess_output_file.dat", 'r')

with open("fail_guess_output_file.dat", 'r') as f:
...
plt.title("Fail Condition Guess Values")
plt.xlabel("Guess Value")
plt.ylabel("Incorrect Guess Count")
plt.savefig("fail_guess_histogram.png")

print("SAVING FIGURE. fail_guess_histogram.png")
